#!/bin/bash
# ============================================================================
# MLPerf Benchmark Setup and Runner - v5.1 Setup Script
#
# Author: Mehdi Nik
# Created: Jan 2026
#
...
print_usage() {
    ...
    echo "  BERT, ResNet50, RetinaNet, 3D-UNet, DLRM-v2,"
    echo "  GPT-J, Llama, Mixtral-8x7B, SDXL, Whisper"
}
...
check_status() {
    ...
    local scripts=(bert resnet50 retinanet 3dunet dlrm gptj llama mixtral sdxl whisper)
    for s in "${scripts[@]}"; do
